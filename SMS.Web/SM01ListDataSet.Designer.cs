...
namespace SMS.Web {
    ...
    public partial class SM01ListDataSet : global::System.Data.DataSet {
        ...
        public partial class sm01_soft_keep_mainDataTable : global::System.Data.TypedTableBase<sm01_soft_keep_mainRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public sm01_soft_keep_mainRow Addsm01_soft_keep_mainRow(string year, string org, string dept, string soft_id, string soft_name) {
...
namespace SMS.Web.SM01ListDataSetTableAdapters {
    ...
    public partial class sm01_soft_keep_mainTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[sm01_soft_keep_main] SET [year] = @year, [org] = @org, [dept] = @dept, [soft_id] = @soft_id, [soft_name] = @soft_name WHERE (([year] = @Original_year) AND ([org] = @Original_org) AND ([dept] = @Original_dept) AND ([soft_id] = @Original_soft_id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT year, org, dept, soft_id, soft_name FROM dbo.sm01_soft_keep_main";
        ...
        public virtual int Fill(SM01ListDataSet.sm01_soft_keep_mainDataTable dataTable) {
        ...
        public virtual SM01ListDataSet.sm01_soft_keep_mainDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SM01ListDataSet.sm01_soft_keep_mainDataTable dataTable = new SM01ListDataSet.sm01_soft_keep_mainDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SM01ListDataSet.sm01_soft_keep_mainDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SM01ListDataSet dataSet) {
        ...
        public virtual int Update(string year, string org, string dept, string soft_id, string soft_name, string Original_year, string Original_org, string Original_dept, string Original_soft_id) {
            if ((year == null)) {
            ...
            if ((Original_org == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_org));
            }
            if ((Original_dept == null)) {
                throw new global::System.ArgumentNullException("Original_dept");
            }
            ...
            if ((Original_soft_id == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_soft_id));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string soft_name, string Original_year, string Original_org, string Original_dept, string Original_soft_id) {
            return this.Update(Original_year, Original_org, Original_dept, Original_soft_id, soft_name, Original_year, Original_org, Original_dept, Original_soft_id);
        }
    }
